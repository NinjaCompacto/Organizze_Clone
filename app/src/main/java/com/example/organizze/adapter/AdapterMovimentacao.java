...
public class AdapterMovimentacao extends RecyclerView.Adapter<AdapterMovimentacao.MyViewHolder> {
    ...
    List<Movimentação> movimentacoes;
    Context context;

    public AdapterMovimentacao(List<Movimentação> movimentacoes, Context context) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        Movimentação movimentacao = movimentacoes.get(position);

        holder.titulo.setText(movimentacao.getDescrição());
        holder.valor.setText(String.valueOf(movimentacao.getValor()));
        holder.categoria.setText(movimentacao.getCateogira());
